...
class CertificateParameters(BaseModel):
    DocumentNumber: str = Field(
        ..., description='Document Number', examples=['GSC123456']
    )
...
class CertificateParameters1(BaseModel):
    DocumentNumber: str = Field(..., description='Document Number', examples=['34567'])


class MutanCertificatePostRequest(BaseModel):
...
class MutanCertificatePostResponse(BaseModel):
...
class MutanCertificatePostResponse1(BaseModel):
...
class MutanCertificatePostResponse2(BaseModel):
...
class MutanCertificatePostResponse3(BaseModel):
...
class MutanCertificatePostResponse4(BaseModel):
...
class MutanCertificatePostResponse5(BaseModel):
...
class MutanCertificatePostResponse6(BaseModel):
